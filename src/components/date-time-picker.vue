      ...
      <v-row justify="space-between" no-gutters class="ma-3">
        <div>
          <v-btn
            ...
            @mousedown="incTime('years')"
            @touchstart.prevent="incTime('years')"
          ...
          <v-btn
            ...
            @mousedown="incTime('months')"
            @touchstart.prevent="incTime('months')"
            ><v-icon>mdi-menu-up</v-icon></v-btn
          >
          <v-btn
            text
            ...
            @mousedown="incTime('days')"
            @touchstart.prevent="incTime('days')"
            ><v-icon>mdi-menu-up</v-icon></v-btn
          >
          <h1>{{ date }}</h1>
          <v-btn
            ...
            class="up_down_bt"
            style="margin-left: 16px"
            @mousedown="decTime('years')"
            @touchstart.prevent="decTime('years')"
          ...
          <v-btn
            ...
            class="up_down_bt"
            style="margin-left: 21px"
            @mousedown="decTime('months')"
            @touchstart.prevent="decTime('months')"
            ><v-icon>mdi-menu-down</v-icon></v-btn
          >
          <v-btn
            text
            ...
            class="up_down_bt"
            style="margin-left: 8px"
            @mousedown="decTime('days')"
            @touchstart.prevent="decTime('days')"
            ><v-icon>mdi-menu-down</v-icon></v-btn
          >
        </div>
        <div>
            ...
            <v-tooltip top>
              <template v-slot:activator="{ on }">
                <v-btn
                  text
                  icon
                  @click="togglePauseTime"
                  style="margin-top: 0px"
                  v-on="on"
                  ><v-icon>{{ togglePauseTimeIcon }}</v-icon></v-btn
                >
              </template>
        ...
        <div>
          <v-btn
            ...
            icon
            class="up_down_bt"
            @mousedown="incTime('hours')"
            @touchstart.prevent="incTime('hours')"
            ><v-icon>mdi-menu-up</v-icon></v-btn
          >
          <v-btn
            text
            icon
            class="up_down_bt ml-1"
            @mousedown="incTime('minutes')"
            @touchstart.prevent="incTime('minutes')"
            ><v-icon>mdi-menu-up</v-icon></v-btn
          >
          <v-btn
            text
            icon
            class="up_down_bt ml-1"
            @mousedown="incTime('seconds')"
            @touchstart.prevent="incTime('seconds')"
            ><v-icon>mdi-menu-up</v-icon></v-btn
          >
          ...
          <v-btn
            ...
            icon
            class="up_down_bt"
            @mousedown="decTime('hours')"
            @touchstart.prevent="decTime('hours')"
            ><v-icon>mdi-menu-down</v-icon></v-btn
          >
          <v-btn
            text
            icon
            class="up_down_bt ml-1"
            @mousedown="decTime('minutes')"
            @touchstart.prevent="decTime('minutes')"
            ><v-icon>mdi-menu-down</v-icon></v-btn
          >
          <v-btn
            text
            icon
            class="up_down_bt ml-1"
            @mousedown="decTime('seconds')"
            @touchstart.prevent="decTime('seconds')"
            ><v-icon>mdi-menu-down</v-icon></v-btn
          >
        </div>
      </v-row>
