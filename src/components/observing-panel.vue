...
<template>
  <div
    id="observing-panel-container"
    :class="{ observingpanelhidden: !$store.state.showSidePanel }"
    class="get-click"
  >
    <div
      class="observing-panel-tabsbtn"
      v-if="$store.state.showObservingPanelTabsButtons"
    >
      <v-btn
        class="tab-bt"
        v-for="tab in tabs"
