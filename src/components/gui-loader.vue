      ...
      <v-layout column align-center style="width: 100%; height: 100%">
        ...
        <div v-if="$store.state.wasmSupport" style="margin: auto">
          <div style="display: flex; justify-content: center">
            <p class="grey--text">
              <i18n path="Loading QUARCS, Power by {0} Edition"
                ><span>Stellarium<sup>Web</sup></span></i18n
              >
            </p>
          </div>
          <div style="display: flex; justify-content: center">
        ...
        <v-card v-else style="margin: auto">
          <v-card-title primary-title>
            <div class="text-h5">
              <h1>{{ $t("Could not show the Online Star Map") }}</h1>
            </div>
            <div class="text-h5" style="margin-top: 30px">
              <v-icon large>error</v-icon>
              {{ $t("It seems that your browser cannot load Web Assembly!") }}
            </div>
          </v-card-title>
          <v-card-text>
            <v-layout column align-center style="width: 100%; height: 100%">
              <p class="grey--text">
                {{
                  $t(
                    "Web assembly is necessary for Stellarium Web to display the star map. Please upgrade your web browser and try again!"
                  )
                }}
              </p>
              <p>
                <i18n path="In the meantime, you can try the {0}!"
